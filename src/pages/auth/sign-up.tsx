                ...
                <div className='auth-page'>
                    ...
                    <div className='auth-header'>
                        <IonToolbar>
                            ...
                            <IonTitle size="small">Create an account with us to get all features</IonTitle>
                        </IonToolbar>
                    </div>
                    <div className='form-wrap'>
                        <form>
                            <IonList lines="none">
                                ...
                                <IonItem class='input-item'>
                                    <IonIcon icon={keyOutline} />
                                    <IonInput type="text" placeholder="Confirm Password" required />
                                </IonItem>
                                ...
                                <IonItem class="ion-text-center">
                                    <IonLabel>Already have an account? <IonButton routerLink="/login" size="small" fill="clear">Log In</IonButton> here</IonLabel>
                                </IonItem>
                            </IonList>
                        </form>
                    </div>
